...
Shader "Custom/Curruption" {
    Properties {
        ...
        _Curruption_Clip ("Curruption_Clip", Range(0, 1)) = 0
...
/// Final Color:
                ...
                float node_917 = (_Diffuse_Texture_var.a*_Color.a);
                float node_4564 = (_noise_value*i.uv0.g);
                float2 node_731_skew = float2(node_4564,node_4564) + 0.2127+float2(node_4564,node_4564).x*0.3713*float2(node_4564,node_4564).y;
                float2 node_731_rnd = 4.789*sin(489.123*(node_731_skew));
                float node_731 = frac(node_731_rnd.x*node_731_rnd.y*(1+node_731_skew.x));
                float node_4628 = (1.0 - (i.uv0.g+(_Curruption_Clip*2.0+-1.5)+saturate(( i.uv0.g > 0.5 ? (1.0-(1.0-2.0*(i.uv0.g-0.5))*(1.0-node_731)) : (2.0*i.uv0.g*node_731) ))));
                fixed4 finalRGBA = fixed4(finalColor,(node_917*node_4628));
...
/// Final Color:
                ...
                float node_731 = frac(node_731_rnd.x*node_731_rnd.y*(1+node_731_skew.x));
                float node_4628 = (1.0 - (i.uv0.g+(_Curruption_Clip*2.0+-1.5)+saturate(( i.uv0.g > 0.5 ? (1.0-(1.0-2.0*(i.uv0.g-0.5))*(1.0-node_731)) : (2.0*i.uv0.g*node_731) ))));
                fixed4 finalRGBA = fixed4(finalColor * (node_917*node_4628),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
