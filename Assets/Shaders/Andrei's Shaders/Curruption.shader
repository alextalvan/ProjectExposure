...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,clamp(((_Diffuse_Texture_var.a*_Color.a)*(i.uv0.g+(_Curruption_Clip*2.0+-1.5))),0,1));
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor * clamp(((_Diffuse_Texture_var.a*_Color.a)*(i.uv0.g+(_Curruption_Clip*2.0+-1.5))),0,1),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
