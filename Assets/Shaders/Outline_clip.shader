...
////// Emissive:
                ...
                float3 node_8820 = (((abs(sin((node_1876.g*_Flikkeringrate)))+_emission_floor)*((1.0 - ceil(((1.0 - ((atan2(node_2130.g,node_2130.r)/6.28318530718)+0.5))-_Clip)))*(_Emssion_Texture_var.rgb*_Emssion_Tint.rgb*_Emission_Intensity)))+(_Diffuse_Texture_var.rgb*_Diffuse_tint.rgb));
                float3 emissive = node_8820;
